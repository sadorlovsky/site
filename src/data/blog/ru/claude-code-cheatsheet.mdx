...
Это не официальная документация. Это моя личная шпаргалка: как я "складываю в голове" разные поверхности Claude Code и какие команды чаще всего нужны.
...
Если поверхности Claude кажутся размытыми, вот разделение, которое реально важно:
