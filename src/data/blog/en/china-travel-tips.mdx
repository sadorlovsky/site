...
<figure>
  <Image src={paymentMethodsImage} alt="Alipay and WeChat Pay payment systems" />
  <figcaption>Two payment systems used in China — Alipay (left) and WeChat Pay (right), also known as Weixin Pay</figcaption>
</figure>
