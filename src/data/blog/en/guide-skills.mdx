...
A skill is a directory with a `SKILL.md` file (YAML frontmatter + Markdown instructions). Claude can load a skill automatically when it’s relevant, or you can run it directly as a `/slash-command`.
