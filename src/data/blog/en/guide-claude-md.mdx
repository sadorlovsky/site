...
Auto memory is supplementary. Claude writes notes on its own as it works (build commands, debugging insights, your preferences). The first 200 lines of `MEMORY.md` are loaded at session start. More details in the [Auto memory](#auto-memory) section.
