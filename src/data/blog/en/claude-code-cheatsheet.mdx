...
This isn’t official documentation. It’s the mental model and command snippets I keep open while using Claude Code. Skim the first sections for “how the surfaces fit together”, then treat the rest as a menu.
